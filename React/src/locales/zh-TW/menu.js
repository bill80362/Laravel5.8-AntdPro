export default {
  ...
  'menu.accountmanage':'【公司】帳號管理',
  'menu.accountmanage.memberlist':'帳號管理',
  'menu.accountmanage.membergrouplist':'帳號群組管理',

  'menu.agentaccountmanage':'【管理員】公司帳號管理',

  'menu.gamemanage':'【公司】項目管理',
  'menu.gamemanage.gamegrouplist':'項目分類列表',
  'menu.gamemanage.gamelist':'項目管理',
